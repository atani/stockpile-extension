// Content Script for Life of Vids
// Extracts metadata and registers downloads

(function() {
  'use strict';

  const SITE_NAME = 'LifeOfVids';
    ...
    document.addEventListener('click', (event) => {
      ...
      if (target && isDownloadElement(target)) {
        ...
        if (href) {
          ...
          console.log('[Stockpile] Registered LifeOfVids download:', href, metadata);
        }
      }
    }, true);
  }
  ...
  function init() {
    console.log('[Stockpile] LifeOfVids content script loaded');
