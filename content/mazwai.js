// Content Script for Mazwai
// Extracts metadata and registers downloads

(function() {
  'use strict';

  const SITE_NAME = 'Mazwai';
    ...
    document.addEventListener('click', (event) => {
      ...
      if (target && isDownloadElement(target)) {
        ...
        if (href) {
          ...
          console.log('[Stockpile] Registered Mazwai download:', href, metadata);
        }
      }
    }, true);
  }
  ...
  function init() {
    console.log('[Stockpile] Mazwai content script loaded');
